...
public class DictionaryProvider extends ContentProvider
{
	...
	private Cursor getSuggestions(String query)
	{
		...
		String[] columns = new String[] { BaseColumns._ID, DicOpenHelper.KEY_WORD,DicOpenHelper.KEY_DEFINITION,SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID};
		/*
	...
	private Cursor search(String query)
	{
		...
		{ BaseColumns._ID, DicOpenHelper.KEY_WORD, DicOpenHelper.KEY_DEFINITION };
